...
vmapping = np.save('seamless/npy/mapping.npy', vmapping)
indices = np.save('seamless/npy/indices.npy', indices)
uvs = np.save('seamless/npy/uvs.npy', uvs)
mesh.export('seamless/npy/mesh.obj')
...
Vue1 = create_view_image(vertices, faces, colors,512,0.3)
Vue2 = create_view_image(vertices, faces, colors,512,1.3)
Vue3 = create_view_image(vertices, faces, colors,512,1.9)

np.savez('seamless/npy/images.npz', Vue1=Vue1, Vue2=Vue2, Vue3=Vue3)
...
plt.imsave('seamless/png/3_views.png', np.concatenate(images, axis=1))
plt.tight_layout()
plt.show()